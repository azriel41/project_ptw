...
@section('breadcrumb')
<div class="col-sm-6">
    <h4 class="page-title">Detail Direktorat</h4>
</div>
@endsection
...
<div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">        
                                        <form method="POST" action="{{ route('direktorat_update',['id'=>$direktorat->direktorat_id]) }}">
                                            {{ csrf_field() }}
                                            {{ method_field('POST') }}
                                            <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Nama Direktorat</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="direktorat_name" class="form-control"  value="{{ $direktorat->direktorat_name }}" disabled="">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-10">
                                                <select class="custom-select" name="direktorat_status" disabled="">
                                                    @if ($direktorat->direktorat_status == 0)
                                                        <option value="0" selected="">Tidak Aktif</option>
                                                        <option value="1">Aktif</option>
                                                    @elseif ($direktorat->direktorat_status == 1)
