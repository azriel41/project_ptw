...
@section('breadcrumb')
<div class="col-sm-6">
    <h4 class="page-title">Edit Direktorat</h4>
</div>
@endsection
                                ...
                                <div class="card">
                                    <div class="card-body">        
                                        <form method="POST" action="{{ route('direktorat_update',['id'=>$direktorat->direktorat_id]) }}">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="direktorat_name" class="form-control"  value=" {{ $direktorat->direktorat_name }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-10">
                                                <select class="custom-select" name="direktorat_status" required>
