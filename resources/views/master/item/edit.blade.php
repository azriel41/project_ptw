                ...
                <div class="card-body">        
                    <form method="POST" action="{{ url('/item/'.$item->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="kode" class="form-control" value="{{ $item->kode }}" readonly="true">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="stok" class="form-control" value="{{ $item->stok }}" readonly="true">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="tipe" name="tipe">
                                    ...
                                    <option value="1" @if($item->tipe == '1') selected @endif>Bahan Baku</option>
                                    <option value="2" @if($item->tipe == '2') selected @endif>Produk Jadi</option>
                                    <option value="3" @if($item->tipe == '3') selected @endif>Mesin</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
