        ...
        <tbody>
            ...
            <tr>
                ...
                <td align="center">
                    ...
                    <a class="btn btn-info" href="{{ route('user_show',['id'=>$user->id]) }}"><i class="fas fa-eye"></i> Show</a>
    
                    <a class="btn btn-primary" href="{{ route('user_edit',['id'=>$user->id]) }}"><i class="fas fa-edit"></i> Edit</a>
