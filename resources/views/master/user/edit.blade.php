                                ...
                                <div class="card">
                                    <div class="card-body">        
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="fullname" class="form-control"  value="{{ $user->email }}">
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="site" class="form-control"  value="{{ $user->site_name }}">
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control required" name="site">
                                                    <option selected="" value="@foreach ($site as $element)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="direktorat" class="form-control"  value="{{ $user->direktorat_name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="departemen" class="form-control"  value="{{ $user->departemen_name }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="unit" class="form-control"  value="{{ $user->unit_name }}">
                                            </div>
                                        </div>
