...
@section('breadcrumb')
<div class="col-sm-6">
    <h4 class="page-title">Detail Departemen</h4>
</div>
@endsection
                                ...
                                <div class="card">
                                    <div class="card-body">        
                                        <form method="POST" action="{{ route('departemen_update',['id'=>$departemen->departemen_id]) }}">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="departemen_name" class="form-control"  value="{{ $departemen->departemen_name }}" disabled="">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-10">
                                                <select class="custom-select" name="departemen_status" disabled="">
